...
class Inscripcion(models.Model):
    ...
    comprobPago = models.ImageField(upload_to='media/pagos', null=False)
    emmac_file = models.ImageField(
        upload_to='media/eventos/emmac_certif', null=False, blank=False, verbose_name='Foto Emmac o Certifidado Medico ')
    ...
    relacion_legal = models.CharField(
        max_length=2, choices=[('1', '------'), ('2', 'Madre'), ('3', 'Padre'), ('4', 'Tutor Legal')], default='' ,null=True, blank=True)
